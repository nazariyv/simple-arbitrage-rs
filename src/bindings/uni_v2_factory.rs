pub use univ2factory_mod::*;
#[allow(clippy::too_many_arguments)]
mod univ2factory_mod {
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for UniV2Factory<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> UniV2Factory<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            let contract =
                ethers::contract::Contract::new(address.into(), UNIV2FACTORY_ABI.clone(), client);
            Self(contract)
        }
